...
export const INITIAL_RWS: RW[] = [
  { id: 'RW 01', namaKetua: 'Asep Juhara', wilayah: 'Dusun Timur (RT 01 & 02)', kontak: '0812-3456-7890' },
  { id: 'RW 02', namaKetua: 'Agus Setiawan', wilayah: 'Dusun Selatan (RT 03 & 04)', kontak: '0821-4567-9012' },
  { id: 'RW 03', namaKetua: 'Dedi Kurniawan', wilayah: 'Dusun Barat (RT 05 & 06)', kontak: '0838-5678-2345' },
  { id: 'RW 04', namaKetua: 'Eko Prasetyo', wilayah: 'Dusun Utara (RT 07 & 08)', kontak: '0857-6789-3456' }
];
